...
if (isGreaterThan(lastDigit, 30)) {
  console.log(`The number ${num6} is greater than 25.`);
} else {
  console.log(`The number ${num6} is not greater than 25.`);
}

function isGreaterThan(lastDigit, value) {
