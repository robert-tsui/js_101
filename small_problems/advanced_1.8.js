// input: number (rational number)
// output: array (of denominators that represent part of the rational number)

// input: array (of denominators that represent part of the rational number)
// output: number (rational number)
